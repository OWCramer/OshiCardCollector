  ...
  return (
    <div className={classes("relative w-48", className)} ref={ref}>
      ...
      >
        ...
        <ChevronDownIcon
          size={14}
          className={classes("shrink-0 opacity-50 transition-transform duration-150", open && "rotate-180")}
        />
      </button>
        ...
        <div className={classes(
          ...
          {items.map((item) => (
            ...
            >
              ...
              {item.value === value && <CheckIcon size={14} className="ml-auto shrink-0 opacity-60" />}
            </button>
          ))}
        </div>
      )}
